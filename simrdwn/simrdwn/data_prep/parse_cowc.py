...
def main():
    ...
    # general settings
    parser.add_argument('--truth_dir', type=str, default='/simrdwn/data/cowc/datasets/ground_truth_sets/Utah_AGRC',
                        help="Location of  ground truth labels")
    parser.add_argument('--simrdwn_data_dir', type=str, default='/simrdwn/data',
                        help="Location of  ground truth labels")
    parser.add_argument('--image_dir', type=str, default='/simrdwn/data/cowc/datasets/ground_truth_sets/Utah_AGRC',
